...
import { MagnifyingGlassIcon, DocumentTextIcon, PlayCircleIcon, ChartBarIcon, ArrowRightCircleIcon, BoltIcon, ClockIcon } from '@heroicons/react/24/solid';

export default function HomeDashboard({ setActiveView }: any) {
  return (
